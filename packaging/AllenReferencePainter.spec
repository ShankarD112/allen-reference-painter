...
a = Analysis([str(root/'packaging/launcher.py')],pathex=[str(root/'src')],binaries=binaries,datas=datas,hiddenimports=hiddenimports,hookspath=[],runtime_hooks=[],excludes=['PyQt5','PyQt6','PySide2','tkinter'],noarchive=False)
pyz = PYZ(a.pure)
